...
public interface PostRepository extends JpaRepository<Post, UUID> {
        ...
        Page<Post> findByAuthorIdAndStatusIn(UUID authorId, Collection<PostStatus> statuses, Pageable pageable);
